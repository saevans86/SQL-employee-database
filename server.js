...
employees AS managers ON employees.manager_id = managers.id;`,
    ...
    //  adding employee and selecting the new role just created not working even though 
              ...
              case 'Add employee':
                inquirer
                    ...
                    .then((answers) => {
                      ...
                      db.query(`INSERT INTO employees (firstname, lastName, role_id, manager_id) VALUES (?, ?, ?, ?)`,
        ...
        async function employeeEditor() {
          db.query(`SELECT * FROM employees`, (err, employeeUpdater) => {
            ...
            db.query(`SELECT * FROM roles`, (err, roleSelector) => {
              ...
              // console.log(chooseExistingRole);
                ...
                case 'Update employee':
                  inquirer.prompt([
                    ...
                    },
                    {
                      ...
                      .then((answers) => {
                        const {employeeChoice, chosenRole} = answers;
                        db.query(`UPDATE employees SET title = (?) WHERE department_id (?)`, [employeeChoice, chosenRole],
                            (err, _results) => {
                              console.error(err);
